...
public class ModelJurnalAdmin {
    ...
    public ModelJurnalAdmin(int id, String judul, String pengarang, String tahun_terbit, String urlimages, String urlpdf, String status_buku_jurnal) {
        this.id = id;
        this.judul = judul;
