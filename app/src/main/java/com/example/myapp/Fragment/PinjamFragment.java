...
import com.example.myapp.SectionPagerAdapterPinjamPengguna;
...
public class PinjamFragment extends Fragment {
    ...
    private void setUpViewPager(ViewPager viewPagerPinjam) {
        SectionPagerAdapterPinjamPengguna adabterpinjam = new SectionPagerAdapterPinjamPengguna(getChildFragmentManager());
