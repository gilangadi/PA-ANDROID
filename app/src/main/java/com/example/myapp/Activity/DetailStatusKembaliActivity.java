...
public class DetailStatusKembaliActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_status_kembali);

        judul = (TextView) findViewById(R.id.judul_detail_status_pengguna_kembali);
        ditulis_oleh = (TextView) findViewById(R.id.ditulis_oleh_detail_status_pengguna_kembali);
        tahunterbit = (TextView) findViewById(R.id.tahun_terbit_detail_status_pengguna_kembali);
        edisi = (TextView) findViewById(R.id.edisi_detail_status_pengguna_kembali);
        nopanggil = (TextView) findViewById(R.id.no_panggil_detail_status_pengguna_kembali);
        isbn_issn = (TextView) findViewById(R.id.isbn_detail_status_pengguna_kembali);
        subjek = (TextView) findViewById(R.id.subjek_detail_status_pengguna_kembali);
        klasifikasi = (TextView) findViewById(R.id.klasifikasi_detail_status_pengguna_kembali);
        judulseri = (TextView) findViewById(R.id.judul_seri_detail_status_pengguna_kembali);
        gmd = (TextView) findViewById(R.id.gmd_detail_status_pengguna_kembali);
        bahasa = (TextView) findViewById(R.id.bahasa_detail_status_pengguna_kembali);
        penerbit = (TextView) findViewById(R.id.penerbit_detail_status_pengguna_kembali);
        tempatterbit = (TextView) findViewById(R.id.tempat_terbit_detail_status_pengguna_kembali);
        abstrak = (TextView) findViewById(R.id.abstrak_detail_status_pengguna_kembali);
        textViewCreated_at = (TextView) findViewById(R.id.tanggal_peminjam_kembali);
        jimg = (ImageView) findViewById(R.id.image_detail_status_pengguna_kembali);
        textViewCreated_at = (TextView) findViewById(R.id.tanggal_peminjam_kembali);
        ...
        idUser = String.valueOf(SharedPrefmanager.getInstance(DetailStatusKembaliActivity.this).getId());

        Toast.makeText(DetailStatusKembaliActivity.this, "id user : " + idUser, Toast.LENGTH_SHORT).show();
        ...
        mActivity = DetailStatusKembaliActivity.this;
    }
