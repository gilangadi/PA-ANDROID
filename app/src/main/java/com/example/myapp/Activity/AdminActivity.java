...
import com.example.myapp.Fragment.InputBukuJurnalAdminFragment;
import com.example.myapp.Fragment.JurnalAdminFragment;
import com.example.myapp.Fragment.StatusAdminFragment;
...
//                negativeButton.setBackgroundColor(Color.parseColor("#FFD9E9FF"));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        int id = item.getItemId();
        if (id == R.id.natives) {
            Intent intent = new Intent(AdminActivity.this, NotifikasiActivity.class);
            startActivity(intent);
            return true;
        }
        if (id == R.id.profil) {
