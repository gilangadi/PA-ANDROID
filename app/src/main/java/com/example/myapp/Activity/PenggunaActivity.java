...
import com.example.myapp.Fragment.KoleksiFragment;
import com.example.myapp.Fragment.PinjamFragment;
...
//                negativeButton.setBackgroundColor(Color.parseColor("#FFD9E9FF"));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        int id = item.getItemId();
        if (id == R.id.natives) {
            Intent intent = new Intent(PenggunaActivity.this, NotifikasiActivity.class);
            startActivity(intent);
            return true;
        }
        if (id == R.id.profil) {
