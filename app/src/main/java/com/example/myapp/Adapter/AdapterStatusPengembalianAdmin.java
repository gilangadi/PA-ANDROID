...
import com.example.myapp.Activity.DetailStatusKembaliAdminActivity;
import com.example.myapp.Fragment.StatusKembaliAdminFragment;
...
public class AdapterStatusPengembalianAdmin extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterStatusPengembalianAdmin(Context context, List<Object> recyclerViewItems, StatusKembaliAdminFragment statusKembaliAdminFragment) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        return new AdapterStatusPengembalianAdmin.MenuItemViewHolder(itemLayoutView);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {

        final AdapterStatusPengembalianAdmin.MenuItemViewHolder menuItemHolder = (AdapterStatusPengembalianAdmin.MenuItemViewHolder) holder;
        ...
        menuItemHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle(((ModelAdminStatusKembali) recyclerViewItems.get(position)).getJudul());
                builder.setItems(dialogItem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        switch (i) {
                            ...
                            case 0:
                                ...
                                intent.putExtra("Id_user", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getId_user());
                                intent.putExtra("Id_rak", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getId_rak());
                                intent.putExtra("Id", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getId());
                                intent.putExtra("Judul", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getJudul());
                                intent.putExtra("Ditulis_oleh", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getDitulis_oleh());
                                intent.putExtra("Tahun_terbit", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getTahun_Terbit());
                                intent.putExtra("Urlimages", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getUrlimages());
                                ...
                                intent.putExtra("Status", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getStatus());
                                intent.putExtra("Edisi", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getEdisi());
                                intent.putExtra("No_panggil", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getNo_panggil());
                                intent.putExtra("Isbn_issn", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getIsbn_issn());
                                intent.putExtra("Subjek", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getSubjek());
                                intent.putExtra("Klasifikasi", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getKlasifikasi());
                                intent.putExtra("Judul_seri", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getJudul_seri());
                                intent.putExtra("Gmd", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getGmd());
                                intent.putExtra("Bahasa", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getBahasa());
                                intent.putExtra("Penerbit", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getPenerbit());
                                intent.putExtra("Tempat_terbit", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getTempat_terbit());
                                intent.putExtra("Abstrak", ((ModelAdminStatusKembali) recyclerViewItems.get(position)).getAbstrak());
                    ...
                    private void deleteKoleksiBuku(int id) {
                        final String URLs = Api.BASE_URL + "/api/listsemuapengembalian/" + id;
...
//        public TextView created_at;
        ...
        MenuItemViewHolder(View itemLayoutView) {
            ...
            ditulis_oleh = (TextView) itemLayoutView.findViewById(R.id.pengarang_admin_status_pengembalian);
