...
import com.example.myapp.Activity.DetailKoleksiJurnalActivity;
import com.example.myapp.Fragment.KoleksiJurnalFragment;
import com.example.myapp.Model.ModelKoleksiJurnal;
...
public class AdapterKoleksiJurnal extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterKoleksiJurnal(Context context, List<Object> recyclerViewItems, KoleksiJurnalFragment koleksiJurnalFragment) {
            ...
            public void onClick(View v) {
                ...
                builder.setItems(dialogItem, new DialogInterface.OnClickListener() {
                    ...
                    private void deleteKoleksiBuku(int id) {
                        final String URLs = Api.BASE_URL + "/api/rakkoleksijurnal/";
