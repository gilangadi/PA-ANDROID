...
import com.example.myapp.Activity.DetailJurnalActivity;
import com.example.myapp.Fragment.JurnalFragment;
import com.example.myapp.Model.ModelJurnal;
import com.example.myapp.R;
import com.example.myapp.Utils.Api;

import java.util.List;

public class AdapterJurnal extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final List<Object> recyclerViewItems;
    private final Context mContext;
    JurnalFragment jurnalFragment;

    public AdapterJurnal(Context context, List<Object> recyclerViewItems, JurnalFragment jurnalFragment) {
